...
public class MemberController {
	...
	public String login(HttpServletRequest req) {
		...
		// 매개변수에 적으면 사용 가능한 이유
		// Spring 제공하는 Argument Resolver(매개변수해결사)rk wkehddmfh
		// 대입해주고 해결해줌.
	...
	public String login(/*@RequestParam("inputEmail")*/ String inputEmail,
						...
						/*@requestParam(value="saveId", required="false", defaultValue=""*/) {
	...
	public String login(/*@ModelAttribute*/ Member inputMember) {
		...
		// ** @ModelAttibute를 이용해 값이 필드에 세팅된 객체를
		//    커맨드 객체 라고 부른다.
	...
	public String login(Member inputMember, Model model,
		...
		// @RequestHeader(value="referer") String referer 밸류 생략하고 값만 써도됨
		// -> 요청 HTTP header에서 "referer" (이전 주소) rkqtdmf djedjdhk
		...
		// required 미작성 시 기본값 true
		// required = false : 필수는 아니지만 null 허용시 사용
		...
		if(loginMember != null) { // 로그인 성공시
			...
			/* Cookie란?
			 * - 클라이언트 즉(브라우저)에서 관리하는 파일
			 * 
			 * - 쿠카파일에 등록된 주소 요청 시 마다
